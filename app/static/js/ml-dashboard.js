...
async function loadRiskDistribution() {
    try {
        const res = await fetch("/predict/risk-distribution");
...
async function loadPatientRiskChart() {
    try {
        const res = await fetch("/reports/patient-risk");
        const data = await res.json();
...
async function loadRecentCriticalChart() {
    try {
        const res = await fetch("/reports/recent-critical");
        const data = await res.json();
...
async function loadUnreviewedCriticalSummary() {
    try {
        const res = await fetch("/reports/unreviewed-critical-summary");
        const data = await res.json();
...
async function loadHighRiskPatientCount() {
    try {
        const res = await fetch("/reports/high-risk-patients");
        const data = await res.json();
...
async function loadHighRiskPatients(riskLevel = 2, limit = 100) {
    try {
        const res = await fetch(`/predict/high-risk?risk_level=${riskLevel}&limit=${limit}`);
